...
/// @nodoc
abstract class _$$DeleteUsersEventImplCopyWith<$Res> {
  factory _$$DeleteUsersEventImplCopyWith(_$DeleteUsersEventImpl value,
          $Res Function(_$DeleteUsersEventImpl) then) =
      __$$DeleteUsersEventImplCopyWithImpl<$Res>;
  @useResult
  $Res call({String userId});
}

/// @nodoc
class __$$DeleteUsersEventImplCopyWithImpl<$Res>
    extends _$DeleteUserEventCopyWithImpl<$Res, _$DeleteUsersEventImpl>
    implements _$$DeleteUsersEventImplCopyWith<$Res> {
  __$$DeleteUsersEventImplCopyWithImpl(_$DeleteUsersEventImpl _value,
      $Res Function(_$DeleteUsersEventImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DeleteUsersEventImpl(
      userId: null == userId
          ? _value.userId
...
class _$DeleteUsersEventImpl implements DeleteUsersEvent {
  const _$DeleteUsersEventImpl({required this.userId});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DeleteUsersEventImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DeleteUsersEventImplCopyWith<_$DeleteUsersEventImpl> get copyWith =>
      __$$DeleteUsersEventImplCopyWithImpl<_$DeleteUsersEventImpl>(
          this, _$identity);
...
abstract class DeleteUsersEvent implements DeleteUserEvent {
  const factory DeleteUsersEvent({required final String userId}) =
      _$DeleteUsersEventImpl;

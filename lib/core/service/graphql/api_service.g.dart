...
class _ApiService implements ApiService {
  ...
  Future<GetAllProductResponce> getAllProducts(
    ...
    _data.addAll(query);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetAllProductResponce>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GetAllProductResponce.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<UserResponceModel> getAllUsers(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<UserResponceModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<BannerResponce> getbanners(Map<String, dynamic> query) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(query);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<BannerResponce>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
